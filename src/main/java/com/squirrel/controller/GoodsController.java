...
//        //将图片保存
        //原始名称
        String oldFileName = image.getOriginalFilename(); //获取上传文件的原名
        //存储图片的物理路径
        ...
        if(image!=null && oldFileName!=null && oldFileName.length()>0){
            ...
            File newFile = new File(file_path+newFileName);
            System.out.println("存储路径："+file_path+newFileName);
            ima.setImgUrl(newFileName);
            //将内存中的数据写入磁盘
...
//        String path="D:/Secondhand/springboot-squirrel/images/data/springboot-squirrel/upload/images/";
//        File uploadFile=new File(path+originFilename);
//        System.out.println("保存路径:"+uploadFile);
//        try{
...
//        }
        ...
        System.out.println("商品路径："+ima.getImgUrl());
    ...
    public Map<String,Object> uploadFile(HttpSession session, MultipartFile myfile2) throws IllegalStateException, IOException{
        //原始名称
