...
public class GgeeConst {
    //本地服务器-文件,图片所在位置
    public static final String UPLOAD_FILE_PATH = "file:D:/Secondhand/springboot-squirrel/images/data/springboot-squirrel/upload/images/";
    public static final String UPLOAD_FILE_IMAGE_PATH = "D:/Secondhand/springboot-squirrel/images/data/springboot-squirrel/upload/images/";
